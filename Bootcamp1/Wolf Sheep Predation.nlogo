...
breed [ wolves wolf ]
turtles-own [ energy age] ; wolves and sheep age and energy
...
to display-labels
  ...
  if show-age? [
    ask wolves [set label round age]
    ask sheep [set label round age]
  ]
end
...
"" ""
PENS
"wolves" 1.0 0 -16777216 true "" "plot mean [age] of wolves"
"sheep" 1.0 0 -14985354 true "" "plot mean [age] of sheep"
