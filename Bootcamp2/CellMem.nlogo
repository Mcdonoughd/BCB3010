globals[]
breed[phosphos phospho]
breed[proteins protein]
proteins-own[phosphodized]
turtles-own[dir]
patches-own[]
...
to make-phosphate
  create-phosphos 1 [
   setxy (random(17) - random(17)) (random(16) + 1)
    set color yellow
    set shape "circle"
  ]
end
...
to move-protein
  ...
  [
    ...
    ;if passed through membrane
    [
      ifelse [pcolor] of patch-ahead -1 = violet
    [
      ;set color blue and release phosphate
      set color blue
      set dir heading
      ask patch xcor ycor[
      sprout-phosphos 1 [
          setxy ((random(17) - random(17))) * dir (random(-16) - 1) * dir
          set color yellow
          set shape "circle"
...
to catch-phosphates
  let prey one-of phosphos-here                    ; grab a random sheep
